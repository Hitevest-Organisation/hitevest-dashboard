    ...
    <aside className="min-h-full p-4 w-64 hidden lg:block">
      ...
      <div className="pb-8">
        ...
        <div className="flex flex-col space-y-4">
          <Link href="/">
            <a className="bg-primary rounded-xl font-bold text-white py-2 px-8 capitalize">
              Dashboard
            </a>
          </Link>
          {[
            ...
            <Link key={i} href={`/${link}`}>
              <a className="rounded-xl font-bold py-2 px-8 text-gray-300 capitalize hover:(text-primary bg-secondary) ">
                {link}
              </a>
            </Link>
          ))}
